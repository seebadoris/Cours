...
public class Ex10opti {

	public static void main(String[] args) {
		// TODO Auto-generated method stub

		final int intUserTVA1=6,intUserTVA2=12,intUserTVA3=21,intUserTVA;
		int intTVA = 0;
		...
		if (intUserTVA ==1||intUserTVA ==2||intUserTVA ==3) {
			...
			if (intUserTVA ==1) {
				...
				System.out.println("Pour un prix brut de "+dblUserPxBrut+ "€, le prix net est de "+dF.format(dblPxNet)+" € (TVA "+intTVA+"%). ");
			}
